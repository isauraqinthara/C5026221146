...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="{{url('/chat/ViewChat')}}">Chat</a>
    </li>
    ...
    <!-- search navbar -->
    <div class="row">
        <form class="form-inline" action="/chat/cari" method="GET">
            <input type="text" class="form-control" name="cari" placeholder="Cari Chat"
